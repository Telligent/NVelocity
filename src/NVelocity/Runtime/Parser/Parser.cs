...
namespace NVelocity.Runtime.Parser
{
	...
	public class Parser
	{
		...
		private String EscapedDirective(String strImage)
		{
			...
			*/
			...
			if (bRecognizedDirective)
				return (strImage[..(iLast / 2)] + strDirective);
			else
				return (strImage);
		}
		...
		{
			/*@bgen(jjtree) process */
			ASTprocess jjtn000 = new(this, ParserTreeConstants.PROCESS);
			bool jjtc000 = true;
		...
		public void EscapedDirective()
		{
			...
			ASTEscapedDirective jjtn000 = new(this, ParserTreeConstants.ESCAPED_DIRECTIVE);
			bool jjtc000 = true;
			nodeTree.OpenNodeScope(jjtn000);
			try
			{
		...
		{
			/*@bgen(jjtree) Escape */
			ASTEscape jjtn000 = new(this, ParserTreeConstants.ESCAPE);
			bool jjtc000 = true;
			nodeTree.OpenNodeScope(jjtn000);
			try
			{
			...
			label_2_brk:
				...
				*/
				...
				if (IsDirective(t.Next.Image[1..]))
					control = true;
				else if (runtimeServices.IsVelocimacro(t.Next.Image[1..], currentTemplateName))
					control = true;
		...
		{
			/*@bgen(jjtree) Comment */
			ASTComment jjtn000 = new(this, ParserTreeConstants.COMMENT);
			nodeTree.OpenNodeScope(jjtn000);
			try
			{
				switch (GetCurrentTokenKind())
		...
		public void NumberLiteral()
		{
			...
			ASTNumberLiteral jjtn000 = new(this, ParserTreeConstants.NUMBER_LITERAL);
			nodeTree.OpenNodeScope(jjtn000);
			try
			{
		...
		public void StringLiteral()
		{
			...
			ASTStringLiteral jjtn000 = new(this, ParserTreeConstants.STRING_LITERAL);
			nodeTree.OpenNodeScope(jjtn000);
			try
			{
		...
		public void Identifier()
		{
			...
			ASTIdentifier jjtn000 = new(this, ParserTreeConstants.IDENTIFIER);
			nodeTree.OpenNodeScope(jjtn000);
			try
			{
		...
		{
			/*@bgen(jjtree) Word */
			ASTWord jjtn000 = new(this, ParserTreeConstants.WORD);
			nodeTree.OpenNodeScope(jjtn000);
			try
			{
		...
		{
			ASTDirective directiveNode = new(this, ParserTreeConstants.DIRECTIVE);
			...
			try
			{
				...
				*/
				...
				ASTBlock jjtn001 = new(this, ParserTreeConstants.BLOCK);
				bool jjtc001 = true;
		...
		public void ObjectArray()
		{
			...
			ASTObjectArray jjtn000 = new(this, ParserTreeConstants.OBJECT_ARRAY);
			bool jjtc000 = true;
			nodeTree.OpenNodeScope(jjtn000);
			//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
			try
		...
		public void IntegerRange()
		{
			...
			ASTIntegerRange jjtn000 = new(this, ParserTreeConstants.INTEGER_RANGE);
			bool jjtc000 = true;
			nodeTree.OpenNodeScope(jjtn000);
			//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
			try
		...
		{
			/*@bgen(jjtree) Method */
			ASTMethod jjtn000 = new(this, ParserTreeConstants.METHOD);
			bool jjtc000 = true;
			nodeTree.OpenNodeScope(jjtn000);
			//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
			try
		...
		public void Reference()
		{
			...
			ASTReference jjtn000 = new(this, ParserTreeConstants.REFERENCE);
			bool jjtc000 = true;
			nodeTree.OpenNodeScope(jjtn000);
			//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
			try
		...
		{
			/*@bgen(jjtree) True */
			ASTTrue jjtn000 = new(this, ParserTreeConstants.TRUE);
			nodeTree.OpenNodeScope(jjtn000);
			try
			{
		...
		{
			/*@bgen(jjtree) False */
			ASTFalse jjtn000 = new(this, ParserTreeConstants.FALSE);
			nodeTree.OpenNodeScope(jjtn000);
			try
			{
		...
		{
			/*@bgen(jjtree) Text */
			ASTText jjtn000 = new(this, ParserTreeConstants.TEXT);
			nodeTree.OpenNodeScope(jjtn000);
			try
			{
				switch (GetCurrentTokenKind())
		...
		* ----------------------------------------------------------------------*/
		...
		public void IfStatement()
		{
			...
			ASTIfStatement jjtn000 = new(this, ParserTreeConstants.IF_STATEMENT);
			bool jjtc000 = true;
			nodeTree.OpenNodeScope(jjtn000);
			//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
			try
		...
		public void ElseStatement()
		{
			...
			ASTElseStatement jjtn000 = new(this, ParserTreeConstants.ELSE_STATEMENT);
			bool jjtc000 = true;
			nodeTree.OpenNodeScope(jjtn000);
			//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
			try
		...
		public void ElseIfStatement()
		{
			...
			ASTElseIfStatement jjtn000 = new(this, ParserTreeConstants.ELSE_IF_STATEMENT);
			bool jjtc000 = true;
			nodeTree.OpenNodeScope(jjtn000);
			//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
			try
		...
		public void SetDirective()
		{
			...
			ASTSetDirective jjtn000 = new(this, ParserTreeConstants.SET_DIRECTIVE);
			bool jjtc000 = true;
			nodeTree.OpenNodeScope(jjtn000);
			//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
			try
		...
		* ----------------------------------------------------------------------*/
		...
		public void Expression()
		{
			...
			ASTExpression jjtn000 = new(this, ParserTreeConstants.EXPRESSION);
			bool jjtc000 = true;
			nodeTree.OpenNodeScope(jjtn000);
			//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
			try
		...
		public void Assignment()
		{
			...
			ASTAssignment jjtn000 = new(this, ParserTreeConstants.ASSIGNMENT);
			bool jjtc000 = true;
			nodeTree.OpenNodeScope(jjtn000);
			//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
			try
		...
		public void ConditionalOrExpression()
		{
			...
			while (true)
			{
				...
				ASTOrNode jjtn001 = new(this, ParserTreeConstants.OR_NODE);
				bool jjtc001 = true;
				nodeTree.OpenNodeScope(jjtn001);
				//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
				try
		...
		public void ConditionalAndExpression()
		{
			...
			while (true)
			{
				...
				ASTAndNode jjtn001 = new(this, ParserTreeConstants.AND_NODE);
				bool jjtc001 = true;
				nodeTree.OpenNodeScope(jjtn001);
				//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
				try
			...
			while (true)
			{
				...
				switch (GetCurrentTokenKind())
				{
					case ParserConstants.LOGICAL_EQUALS:
						...
						ASTEQNode jjtn001 = new(this, ParserTreeConstants.EQ_NODE);
						bool jjtc001 = true;
						nodeTree.OpenNodeScope(jjtn001);
						//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
						try
					...
					case ParserConstants.LOGICAL_NOT_EQUALS:
						...
						ASTNENode jjtn002 = new(this, ParserTreeConstants.NE_NODE);
						bool jjtc002 = true;
			...
			while (true)
			{
				...
				switch (GetCurrentTokenKind())
				{
					case ParserConstants.LOGICAL_LT:
						...
						ASTLTNode jjtn001 = new(this, ParserTreeConstants.LT_NODE);
						bool jjtc001 = true;
						nodeTree.OpenNodeScope(jjtn001);
						//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
						try
					...
					case ParserConstants.LOGICAL_GT:
						...
						ASTGTNode jjtn002 = new(this, ParserTreeConstants.GT_NODE);
						bool jjtc002 = true;
						nodeTree.OpenNodeScope(jjtn002);
						//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
						try
					...
					case ParserConstants.LOGICAL_LE:
						...
						ASTLENode jjtn003 = new(this, ParserTreeConstants.LE_NODE);
						bool jjtc003 = true;
					...
					case ParserConstants.LOGICAL_GE:
						...
						ASTGENode jjtn004 = new(this, ParserTreeConstants.GE_NODE);
						bool jjtc004 = true;
			...
			while (true)
			{
				...
				switch (GetCurrentTokenKind())
				{
					case ParserConstants.PLUS:
						...
						ASTAddNode jjtn001 = new(this, ParserTreeConstants.ADD_NODE);
						bool jjtc001 = true;
						nodeTree.OpenNodeScope(jjtn001);
						//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
						try
					...
					case ParserConstants.MINUS:
						...
						ASTSubtractNode jjtn002 = new(this, ParserTreeConstants.SUBTRACT_NODE);
						bool jjtc002 = true;
						nodeTree.OpenNodeScope(jjtn002);
						//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
						try
			...
			while (true)
			{
				...
				switch (GetCurrentTokenKind())
				{
					case ParserConstants.MULTIPLY:
						...
						ASTMulNode jjtn001 = new(this, ParserTreeConstants.MUL_NODE);
						bool jjtc001 = true;
						nodeTree.OpenNodeScope(jjtn001);
						//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
						try
					...
					case ParserConstants.DIVIDE:
						...
						ASTDivNode jjtn002 = new(this, ParserTreeConstants.DIV_NODE);
						bool jjtc002 = true;
						nodeTree.OpenNodeScope(jjtn002);
						//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
						try
					...
					case ParserConstants.MODULUS:
						...
						ASTModNode jjtn003 = new(this, ParserTreeConstants.MOD_NODE);
						bool jjtc003 = true;
						nodeTree.OpenNodeScope(jjtn003);
						//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
						try
		...
		public void UnaryExpression()
		{
			if (jj_2_11(2))
			{
				...
				ASTNotNode jjtn001 = new(this, ParserTreeConstants.NOT_NODE);
				bool jjtc001 = true;
				nodeTree.OpenNodeScope(jjtn001);
				//UPGRADE_NOTE: Exception 'java.lang.Throwable' was converted to ' ' which has different behavior. 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="jlca1100"'
				try
